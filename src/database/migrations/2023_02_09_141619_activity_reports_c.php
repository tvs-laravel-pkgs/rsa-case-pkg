	...
	public function up() {
		if (!Schema::hasTable('activity_reports')) {
			Schema::create('activity_reports', function (Blueprint $table) {
				...
				$table->string('cc_collected_amount', 60)->nullable();
				$table->string('cc_not_collected_amount', 60)->nullable();
				...
				$table->string('cc_service_charges', 60)->nullable();
				$table->string('cc_membership_charges', 60)->nullable();
				$table->string('cc_eatable_items_charges', 60)->nullable();
				$table->string('cc_toll_charges', 60)->nullable();
				$table->string('cc_green_tax_charges', 60)->nullable();
				$table->string('cc_border_charges', 60)->nullable();
				$table->string('cc_octroi_charges', 60)->nullable();
				$table->string('cc_excess_charges', 60)->nullable();
				$table->string('cc_fuel_charges', 60)->nullable();

				$table->string('asp_service_charges', 60)->nullable();
				$table->string('asp_membership_charges', 60)->nullable();
				$table->string('asp_eatable_items_charges', 60)->nullable();
				$table->string('asp_toll_charges', 60)->nullable();
				$table->string('asp_green_tax_charges', 60)->nullable();
				$table->string('asp_border_charges', 60)->nullable();
				$table->string('asp_octroi_charges', 60)->nullable();
				$table->string('asp_excess_charges', 60)->nullable();
				$table->string('asp_fuel_charges', 60)->nullable();

				$table->string('bo_service_charges', 60)->nullable();
				$table->string('bo_membership_charges', 60)->nullable();
				$table->string('bo_eatable_items_charges', 60)->nullable();
				$table->string('bo_toll_charges', 60)->nullable();
				$table->string('bo_green_tax_charges', 60)->nullable();
				$table->string('bo_border_charges', 60)->nullable();
				$table->string('bo_octroi_charges', 60)->nullable();
				$table->string('bo_excess_charges', 60)->nullable();
				$table->string('bo_fuel_charges', 60)->nullable();

				$table->string('asp_waiting_time', 191)->nullable();
				$table->string('bo_waiting_time', 191)->nullable();
				$table->string('cc_waiting_charges', 60)->nullable();
				$table->string('asp_waiting_charges', 60)->nullable();
				$table->string('bo_waiting_charges', 60)->nullable();
				...
				$table->string('bo_collected', 60)->nullable();
				$table->string('bo_not_collected', 60)->nullable();
				$table->string('asp_km_travelled', 191)->nullable();
				$table->string('asp_collected', 60)->nullable();
				$table->string('asp_not_collected', 60)->nullable();
				$table->string('cc_po_amount', 60)->nullable();
				$table->string('cc_net_amount', 60)->nullable();
				$table->string('cc_amount', 60)->nullable();
				$table->string('bo_tax_amount', 60)->nullable();
				$table->string('bo_net_amount', 60)->nullable();
				$table->string('bo_po_amount', 60)->nullable();
				$table->string('bo_deduction', 60)->nullable();
				$table->string('bo_amount', 60)->nullable();
				$table->string('asp_po_amount', 60)->nullable();
				$table->string('asp_net_amount', 60)->nullable();
				$table->string('asp_amount', 60)->nullable();
