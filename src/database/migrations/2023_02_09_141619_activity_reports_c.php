	...
	public function up() {
		if (!Schema::hasTable('activity_reports')) {
			Schema::create('activity_reports', function (Blueprint $table) {
				...
				$table->decimal('cc_collected_amount', 12, 2)->nullable();
				$table->decimal('cc_not_collected_amount', 12, 2)->nullable();
				...
				$table->decimal('cc_service_charges', 12, 2)->nullable();
				$table->decimal('cc_membership_charges', 12, 2)->nullable();
				$table->decimal('cc_eatable_items_charges', 12, 2)->nullable();
				$table->decimal('cc_toll_charges', 12, 2)->nullable();
				$table->decimal('cc_green_tax_charges', 12, 2)->nullable();
				$table->decimal('cc_border_charges', 12, 2)->nullable();
				$table->decimal('cc_octroi_charges', 12, 2)->nullable();
				$table->decimal('cc_excess_charges', 12, 2)->nullable();
				$table->decimal('cc_fuel_charges', 12, 2)->nullable();

				$table->decimal('asp_service_charges', 12, 2)->nullable();
				$table->decimal('asp_membership_charges', 12, 2)->nullable();
				$table->decimal('asp_eatable_items_charges', 12, 2)->nullable();
				$table->decimal('asp_toll_charges', 12, 2)->nullable();
				$table->decimal('asp_green_tax_charges', 12, 2)->nullable();
				$table->decimal('asp_border_charges', 12, 2)->nullable();
				$table->decimal('asp_octroi_charges', 12, 2)->nullable();
				$table->decimal('asp_excess_charges', 12, 2)->nullable();
				$table->decimal('asp_fuel_charges', 12, 2)->nullable();

				$table->decimal('bo_service_charges', 12, 2)->nullable();
				$table->decimal('bo_membership_charges', 12, 2)->nullable();
				$table->decimal('bo_eatable_items_charges', 12, 2)->nullable();
				$table->decimal('bo_toll_charges', 12, 2)->nullable();
				$table->decimal('bo_green_tax_charges', 12, 2)->nullable();
				$table->decimal('bo_border_charges', 12, 2)->nullable();
				$table->decimal('bo_octroi_charges', 12, 2)->nullable();
				$table->decimal('bo_excess_charges', 12, 2)->nullable();
				$table->decimal('bo_fuel_charges', 12, 2)->nullable();

				$table->string('asp_waiting_time', 191)->nullable();
				$table->string('bo_waiting_time', 191)->nullable();
				$table->decimal('cc_waiting_charges', 12, 2)->nullable();
				$table->decimal('asp_waiting_charges', 12, 2)->nullable();
				$table->decimal('bo_waiting_charges', 12, 2)->nullable();
				...
				$table->decimal('bo_collected', 12, 2)->nullable();
				$table->decimal('bo_not_collected', 12, 2)->nullable();
				$table->string('asp_km_travelled', 191)->nullable();

				$table->decimal('asp_collected', 12, 2)->nullable();
				$table->decimal('asp_not_collected', 12, 2)->nullable();
				$table->decimal('cc_po_amount', 12, 2)->nullable();
				$table->decimal('cc_net_amount', 12, 2)->nullable();
				$table->decimal('cc_amount', 12, 2)->nullable();
				$table->decimal('bo_tax_amount', 12, 2)->nullable();
				$table->decimal('bo_net_amount', 12, 2)->nullable();
				$table->decimal('bo_po_amount', 12, 2)->nullable();
				$table->decimal('bo_deduction', 12, 2)->nullable();
				$table->decimal('bo_amount', 12, 2)->nullable();
				$table->decimal('asp_po_amount', 12, 2)->nullable();
				$table->decimal('asp_net_amount', 12, 2)->nullable();
				$table->decimal('asp_amount', 12, 2)->nullable();
