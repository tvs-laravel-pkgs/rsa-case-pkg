	...
	public function run() {
		$permissions = [
			...
			[
				...
				'parent' => 'membership',
				'name' => 'mytvs-policies',
				'display_name' => 'MyTVS Policies',
			],
			[
				'display_order' => 30,
				'parent' => 'membership',
				'name' => 'view-mytvs-policy',
				'display_name' => 'View MyTVS Policy',
			],
			[
				'display_order' => 31,
				'parent' => 'membership',
			...
			[
				'display_order' => 6,
				'parent' => 'sales_data_upload',
				'name' => 'repush-failed-direct-sale-transaction',
				'display_name' => 'Re-push failed direct sale transaction',
			],
