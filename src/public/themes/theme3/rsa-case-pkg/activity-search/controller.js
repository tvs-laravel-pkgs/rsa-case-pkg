  ...
  controller: function (
    ...
    $scope.searchActivity = () => {
      if (
        ...
        custom_noty(
          "error",
          "Enter Case Number / Vehicle Registration Number / VIN / Mobile Number / CRM Activity ID / CSR",
        );
        return;
      }
        ...
        $.extend(activitySearchDtConfig, {
          ...
          columns: [
            ...
            { data: "case_number", name: "cases.number", searchable: true },
            {
              ...
              name: "cases.vehicle_registration_number",
              searchable: true,
            },
            { data: "vin", name: "cases.vin_no", searchable: true },
            { data: "asp", name: "asps.asp_code", searchable: true },
            {
              data: "crm_activity_id",
              name: "activities.crm_activity_id",
              searchable: true,
            },
            ...
            {
              data: "finance_status",
              name: "activity_finance_statuses.name",
              searchable: true,
            },
            {
              data: "status",
              name: "activity_portal_statuses.name",
              searchable: true,
            },
            {
              data: "activity_status",
              name: "activity_statuses.name",
              searchable: true,
            },
            { data: "client", name: "clients.name", searchable: true },
            {
              data: "call_center",
              name: "call_centers.name",
              searchable: true,
            },
          ],
          ordering: false,
